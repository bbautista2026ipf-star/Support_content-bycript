...
Utilizan el lenguaje **SQL** (*Structured Query Language*) para realizar consultas y operaciones sobre los datos: `SELECT` (consultar), `UPDATE` (actualizar), `DELETE` (eliminar) e `INSERT` (insertar nuevos registros).
