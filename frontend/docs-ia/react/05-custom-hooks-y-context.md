...
`useContext` es el Hook que permite acceder a un contexto específico en la jerarquía de componentes, para compartir datos "globales" **sin pasar props manualmente nivel por nivel** (evitando el problema conocido como *"prop drilling"*).
