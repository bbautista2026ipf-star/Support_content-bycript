...
| **JSX** (*JavaScript XML*) | Extensión de JavaScript que permite escribir una sintaxis parecida a HTML dentro del código JavaScript. Se compila a JavaScript puro antes de ejecutarse en el navegador. |
...
| Build de producción con Rolldown | La versión actual de Vite (8.x) usa un *bundler* de producción basado en Rust, acelerando significativamente los builds respecto a versiones anteriores. |
