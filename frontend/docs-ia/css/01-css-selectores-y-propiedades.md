...
**CSS** (*Cascading Style Sheets* — Hojas de Estilo en Cascada) es un lenguaje de diseño utilizado en conjunto con HTML para crear páginas web atractivas y visualmente agradables. Permite controlar la presentación de los elementos HTML: color, tamaño, fuente, margen, relleno, etc.
